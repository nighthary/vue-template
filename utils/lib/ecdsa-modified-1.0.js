...
const ASN1HEX = require('./asn1hex-1.1');
const BigInteger = require('./jsbn2');
if (typeof MCSCA == "undefined" || !MCSCA) var MCSCA = {};
if (typeof MCSCA.crypto == "undefined" || !MCSCA.crypto) MCSCA.crypto = {};

/**
 * class for EC key generation,  ECDSA signing and verifcation
 * @name MCSCA.crypto.ECDSA
 * @class class for EC key generation,  ECDSA signing and verifcation
 * @description
 * <p>
 * CAUTION: Most of the case, you don't need to use this class except
 * for generating an EC key pair. Please use {@link MCSCA.crypto.Signature} class instead.
 * </p>
 * <p>
 ...
 * </p>
 */
MCSCA.crypto.ECDSA = function (params) {
   ...
   * @example
   * var ec = MCSCA.crypto.ECDSA({'curve': 'secp256r1'});
 ...
 */
MCSCA.crypto.ECDSA.parseSigHex = function (sigHex) {
  var p = MCSCA.crypto.ECDSA.parseSigHexInHexRS(sigHex);
 ...
 */
MCSCA.crypto.ECDSA.parseSigHexInHexRS = function (sigHex) {
 ...
 * @since ecdsa-modified 1.0.3
 */
MCSCA.crypto.ECDSA.asn1SigToConcatSig = function (asn1Sig) {
  var pSig = MCSCA.crypto.ECDSA.parseSigHexInHexRS(asn1Sig);
  var hR = pSig.r;
  var hS = pSig.s;
 ...
 * @since ecdsa-modified 1.0.3
 */
MCSCA.crypto.ECDSA.concatSigToASN1Sig = function (concatSig) {
  ...
  return MCSCA.crypto.ECDSA.hexRSSigToASN1Sig(hR, hS);
};
 ...
 * @since ecdsa-modified 1.0.3
 */
MCSCA.crypto.ECDSA.hexRSSigToASN1Sig = function (hR, hS) {
  var biR = new BigInteger(hR, 16);
  var biS = new BigInteger(hS, 16);
  return MCSCA.crypto.ECDSA.biRSSigToASN1Sig(biR, biS);
};
 ...
 * @since ecdsa-modified 1.0.3
 */
MCSCA.crypto.ECDSA.biRSSigToASN1Sig = function (biR, biS) {
  var derR = new MCSCA.asn1.DERInteger({'bigint': biR});
  var derS = new MCSCA.asn1.DERInteger({'bigint': biS});
