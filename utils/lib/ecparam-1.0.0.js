 ...
 * @name MCSCA.crypto.ECParameterDB
 ...
 * the name marked (*) are available for {@link MCSCA.crypto.ECDSA} and
 * {@link MCSCA.crypto.Signature} classes.
 * <ul>
 * <li>secp128r1</li>
 * <li>secp160r1</li>
 * <li>secp160k1</li>
 ...
 */
MCSCA.crypto.ECParameterDB = new function () {
  var db = {};
  var aliasDB = {};
...
MCSCA.crypto.ECParameterDB.regist(
